<script setup>
    ...
    import TypeShuffle from '@/utils/type_shuffle'
    import Parallax from 'parallax-js'
    import SocialComponent from '@/components/SocialComponent.vue'

    let ts = reactive({})
    const loaded = ref(false)
    const socialComponentVisible = ref(false)

    onMounted(() => {
        const scene = document.querySelector('#ascii')
        new Parallax(scene)

        document.fonts.ready.then(function () {
            const textElement = document.querySelector('.content')
            ts = reactive(new TypeShuffle(textElement))
            loaded.value = true
            ts.trigger('fx1')
            setTimeout(() => {
    ...
    <main class="home flex">
        <div class="content" :class="{ transparent: !loaded }">
            ...
            <Transition name="slide-fade">
                <SocialComponent v-show="socialComponentVisible" />
            </Transition>
        </div>
        <div class="ascii-wrapper" id="ascii" @click="ts.trigger('fx4')">
            <pre class="ascii" data-depth="0.4">
          ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣀⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣤⣶⡎⠉⠀⠙⢧⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣠⠿⠉⠀⠀⠀⠀⠀⠈⢳⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⡼⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⢻⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
